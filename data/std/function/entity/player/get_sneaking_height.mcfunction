#>std:entity/player/get_sneaking_height
#
# Gets the current sneaking height of the player. The returned value scales with
...
scoreboard players set __$std_base __std.get_height 1500
