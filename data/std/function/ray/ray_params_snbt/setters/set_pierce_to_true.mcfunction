#>std:ray/ray_params_snbt/setters/set_pierce_to_true
#
# Sets the pierce property of the ray_params_snbt object to true.
#
# @params
...
# set value
$data modify storage $(params_st) $(params_path).pierce set value true
