#>std.core:array/foreach/iterate
#
# @authors scrmbl-egg
# @input
#   arr: [any]
...
#           $(elem_macro)
#           $(idx_macro)
function std.core:array/foreach/bind_storage_copy with storage std:temp foreach
...
#           $(elem_macro)
#           $(idx_macro)
function std.core:array/foreach/run_function_with_element \
